...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, PWROK_Pin|AC_LOSS_Pin|FAN_ON_Pin|PCI_12V_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MCU_IRQ_GPIO_Port, MCU_IRQ_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, HP_SHDN_Pin|PWR_SW_Pin|WAKE_Pin|PERST_Pin
                          |CLKREQ_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PWROK_Pin FAN_ON_Pin */
  GPIO_InitStruct.Pin = PWROK_Pin|FAN_ON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
