...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, LED_WHITE_Pin|LED_RED_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LED_WHITE_Pin LED_RED_Pin */
  GPIO_InitStruct.Pin = LED_WHITE_Pin|LED_RED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : LOCK_DET_Pin */
  GPIO_InitStruct.Pin = LOCK_DET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LOCK_DET_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : RSV0_Pin */
  GPIO_InitStruct.Pin = RSV0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(RSV0_GPIO_Port, &GPIO_InitStruct);
