/**
 * This is the reverse engineered from AMITSE.efi dumped from the BIOS image.
 * The function detects if XG Mobile has been disconnected at boot and if needed
...

{
  ...
  if ((bVar1 & 4) == 0) {
                    /* GPUM == 0x02 */
                    /* EGIF [0x00] == 0x40 (established) */
                    /* EGIF [0x01] != 3 (connected & locked) */
                    /* EGIF [0x02] != 0 (power loss) */
                    /* EGIF [0x03] != 0x02 (MCU I2C ack) */
    ...
    FUN_00013d30(50000);
                    ...
                    /* reconnect bit set by this boot or previous boot */
  if ((bVar1 & 0x40) != 0) {
    reconnect_xgm();
  }
  local_res8[0] = 0;
      ...
      if (*(int *)DAT_0001fc00[3] != 0) {
        do {
          ...
          if ((lVar3 == 0) && (local_70 != 0)) {
            ...
            if (((uVar11 < uVar1) || (uVar8 < *(uint *)(local_68 + 8))) &&
